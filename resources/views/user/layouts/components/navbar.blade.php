<nav class="flex sticky top-0 bg-slate-100 z-50 text-black items-center justify-between px-5 py-5 w-full">
    <div>
        <h1 class="text-xl font-semibold">BudayaNusantara</h1>
    </div>
    <ul id="drawer" role="menu"
        class="sm:gap-3 max-md:hidden md:gap-8 transition-left ease-[cubic-bezier(0.4, 0.0, 0.2, 1)] delay-150  sm:flex  flex flex-col cursor-pointer absolute min-h-screen -left-48 sm:static w-48 top-0  sm:shadow-none shadow-xl sm:bg-transparent sm:flex-row sm:w-auto sm:min-h-0 ">
