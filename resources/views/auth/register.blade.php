...
@section('content')
    <div class="flex bg-[#ff9532] justify-center items-center h-screen relative">
        ...
        <div class="bg-white p-8 rounded shadow-2xl max-w-sm w-full">
            <h2 class="text-2xl font-semibold mb-6">Registrasi</h2>
            <form action="{{ route('register') }}" method="POST">
                ...
                <div class="flex items-center justify-between">
                    <button type="submit"
                        class="text-white bg-[#EA580C] hover:ring-[#EA580C] hover:bg-transparent hover:ring-1 hover:text-[#EA580C] transition-all ease-in-out py-2 px-5 rounded-md">Register</button>
                    <p class="text-sm ">Sudah punya akun? <a href="{{ route('login.form') }}"
                            class="text-[#EA580C] hover:text-[#ff9a64]">Login</a></p>
                </div>
            </form>
        </div>
    </div>
