<header class="z-10 py-3  shadow-md bg-gray-800">
    <div class="container flex items-center justify-between h-full px-6 mx-auto  text-purple-300">
        ...
        {{-- <div class="flex justify-center flex-1 lg:mr-32">
            <div class="relative w-full max-w-xl mr-6 focus-within:text-purple-500">
                ...
                <input
                    class="w-full pl-8 pr-2 text-sm border-0 rounded-md placeholder-gray-500 focus:shadow-outline-gray focus:placeholder-gray-600 bg-gray-700 text-gray-200 focus:bg-white focus:border-purple-300 focus:outline-none focus:shadow-outline-purple form-input"
                    type="text" placeholder="Search for projects" aria-label="Search" />
            </div>
        </div> --}}
        <ul class="items-center flex-shrink-0 space-x-6 hidden">
            <!-- Theme toggler -->
            <!-- Notifications menu -->
            <li class="relative">
                    ...
                    <ul x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100"
                        ...
                        <li class="flex">
                            <form class="w-full" action="{{ route('logout') }}" method="POST">
                                @csrf
                                <button class="inline-flex items-center w-full px-2 py-1 text-sm font-semibold transition-colors duration-150 rounded-md hover:bg-gray-800 hover:text-gray-200"
                                    type="submit">
